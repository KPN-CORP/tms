                                        ...
                                        <div class="{{ $modalCard }} text-left" x-transition.opacity x-init="$nextTick(() => window.tmsInit && window.tmsInit($el))">
                                            ...
                                            <form method="POST" action="{{ route('projects.implementation.update', [$project, $plan]) }}" class="space-y-3">
                                                ...
                                                <div class="grid grid-cols-2 gap-2">
                                                    ...
                                                    <label class="text-xs text-gray-500">Planning End<input type="date" name="planning_end" value="{{ optional($plan->planning_end)->format('Y-m-d') }}" class="{{ $inp }} w-full"></label>
                                                </div>
                        ...
                        <form method="POST" action="{{ route('projects.implementation.store', $project) }}" class="space-y-3">
                            ...
                            <template x-for="(row, i) in rows" :key="row._id">
                                <div class="border rounded-lg p-3 grid grid-cols-2 gap-2 relative">
                                    ...
                                    <label class="text-xs text-gray-500">Planning Start<input type="date" :name="'rows['+i+'][planning_start]'" x-model="row.planning_start" class="{{ $inp }} w-full"></label>
                                    <label class="text-xs text-gray-500">Planning End<input type="date" :name="'rows['+i+'][planning_end]'" x-model="row.planning_end" class="{{ $inp }} w-full"></label>
                                    @if($showActual)
