    ...
    <div class="p-6 space-y-6">
        ...
        <form method="GET" class="bg-white rounded-xl shadow overflow-hidden">
            ...
            <x-list-filter-bar :business-units="$businessUnits" :departments="$departments"
                :reset-route="route('ideas.drafts')" placeholder="Cari ID Idea, nama, atau problem…" />
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left">
                    ...
                    <tbody class="divide-y">
                        ...
                        @empty
                            <tr><td colspan="6" class="px-6 py-8 text-center text-gray-400">Belum ada draft.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
